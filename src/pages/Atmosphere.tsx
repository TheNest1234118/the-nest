        ...
        >
          ...
          <label
            ...
            style={{
              ...
              border: `1px solid ${
                fileName ? "rgba(205,170,100,0.12)" : "rgba(255,255,255,0.065)"
              }`,
              borderRadius: 15,
              padding: "16px 18px",
              cursor: "pointer",
          ...
          >
            {loading ? (
              <span style={{ fontSize: 12, color: "rgba(205,170,100,0.42)", fontWeight: 300 }}>
                Reading audio...
              </span>
            ) : fileName ? (
              <>
              ...
              <>
                ...
                <div>
                  <div style={{ fontSize: 13, fontWeight: 400, color: "rgba(210,192,165,0.58)" }}>
                    Upload a track
                  </div>
                  <div
                    style={{
                      fontSize: 10,
                      color: "rgba(148,134,112,0.32)",
                      fontWeight: 300,
                      marginTop: 2,
                    }}
                  >
  ...
  <span>{tracks.length}</span>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${
                      active ? "rgba(205,170,100,0.20)" : "rgba(255,255,255,0.055)"
                    }`,
                    borderRadius: 13,
                    padding: "13px 14px",
                    cursor: "pointer",
                ...
                >
                  <div
                    style={{
                      fontSize: 12,
                      fontWeight: 400,
                      color: active ? "rgba(228,205,160,0.88)" : "rgba(200,182,158,0.50)",
                      marginBottom: 2,
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {(Object.entries(SPEEDS) as [SpeedKey, { label: string; rate: number }][]).map(
              ([key, { label }]) => {
        ...
        >
          <button
            ...
            style={{
              ...
              border: `1px solid ${
                hasBuffer || isPlaying ? "rgba(205,170,100,0.20)" : "rgba(255,255,255,0.06)"
              }`,
          ...
          >
            {isPlaying ? (
              ...
              <Play
                size={18}
                strokeWidth={1.4}
                color={hasBuffer ? "rgba(205,170,100,0.72)" : "rgba(145,130,108,0.26)"}
                style={{ marginLeft: 2 }}
              />
            )}
          </button>
